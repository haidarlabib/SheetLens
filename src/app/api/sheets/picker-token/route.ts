...
export async function GET() {
  ...
  try {
    ...
    const appId = process.env.NEXT_PUBLIC_GOOGLE_APP_ID || clientId.split("-")[0] || "";
    const apiKey = process.env.NEXT_PUBLIC_GOOGLE_PICKER_API_KEY || process.env.NEXT_PUBLIC_GOOGLE_API_KEY || "";
